...
<head>
  ...
  <link rel="stylesheet" href="/member/css/newarrivalsstyle.css">
  <link rel="stylesheet" href="/member/css/bookcategories.css">
...
<body>
  ...
  <br><br>
    ...
    <div class="column">
      <div class="card">
        <center><img src="/member/images/placements.jpg" alt="Mike" style="width:100%" height="175"></center>
    ...
    <div class="column">
      <div class="card">
        <center><img src="/member/images/history.jpg" alt="Mike" style="width:100%" height="175"></center>
        <div class="ccontainer">
          <p class="title" style="color: brown;">let's learn</p>
    ...
    <div class="column">
      <div class="card">
        <center><img src="/member/images/aws.jpg" alt="Mike" style="width:100%" height="175"></center>
        <div class="ccontainer">
          <p class="title" style="color: brown;">let's learn</p>
    ...
    <div class="column">
      <div class="card">
        <center><img src="/member/images/stories.jpg" alt="Mike" style="width:100%" height="175"></center>
        <div class="ccontainer">
          <p class="title" style="color: brown;">let's learn</p>
    ...
    <div class="column">
      <div class="card">
        <center><img src="/member/images/programming.jpg" alt="Mike" style="width:100%" height="175"></center>
        <div class="ccontainer">
          <p class="title" style="color: brown;">let's learn</p>
