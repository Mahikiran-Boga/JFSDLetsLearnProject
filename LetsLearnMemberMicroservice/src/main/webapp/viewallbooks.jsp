...
<body>
   ...
   <%--  <div id="product-list">
    ...
    <c:forEach items="${bdata}" var="book">
        <div class="product">
            <h3 style="color: brown" align="left"> 𝒍𝒆𝒕'𝒔 𝒍𝒆𝒂𝒓𝒏 !   <img src="/member/images/book.png" width="22px" height="22" /></h3>
            <p>Book ID: ${book.bid}</p>
            ...
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star"></span>
            <a href="/member/download/${book.bname}"><button class="button">Download Here</button></a>
        </div>
    </c:forEach>
</div>
