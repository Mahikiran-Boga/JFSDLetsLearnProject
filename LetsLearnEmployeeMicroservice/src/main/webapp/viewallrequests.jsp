...
.custom-table .delete-button:hover {
  ...
  <link rel="stylesheet" href="/emp/css/empstyle.css">
  <link rel="shortcut icon" type="image/png" href="/emp/images/book.png"/>
...
<body>
  <nav>
   ...
   <img src="/emp/images/book.png" width="30px" height="30" />
</a>
      </div>
      <ul class="nav-links">
  ...
  <section class="home">
   ...
   <img src="/emp/images/book.png" width="20px" height="20" /><br>
</a>
            ...
            <table class="custom-table">
                ...
                <c:forEach items="${reqdata}" var="req">
                  ...
                  <tr>
                   ...
                   <td><a href="/emp/action?bname=${req.bookName}&status=true"><button class="accept-button" style="font-weight: bold; color: black;" >Accept</button></a>
                    <a href="/emp/action?bname=${req.bookName}&status=false"><button class="delete-button" >Decline</button></a>
                  </td>
</td>
                  </tr>
                  </c:forEach>
